    ...
    <div className="p-6">
      ...
      <div className="mt-8">
        ...
        <p className="py-4 text-gray-500 ">
          ...
          <span className="text-blue-500">Skysecure</span>
        </p>
      </div>
      {/* Toast notification */}
      {toast.show && (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-40">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
            ...
            <div className="flex space-x-3">
              ...
              <button
                type="button"
                className="flex-1 py-2 bg-blue-600 rounded-md text-white font-medium"
                onClick={verifyOtp}
              >
                Verify
              </button>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          <button
            type="submit"
            className="w-full bg-blue-600 text-white h-10 rounded-md"
          >
            Continue
          </button>
